...
<section>
    <h1 class="text-center font-hurricane text-5xl">save your moments </h1>
    </section>
    </body>
<!---gambar  ku--->
    ...
    <div class="flex justify-center gap-4 flex-wrap">
        <div>
            <div class="flex flex-col gap-4">
                <div class="">
                  <img src="/assets/kucing2.jpg" alt="" class="rounded-1g w-[200px]">
                </div>
                <div class="">
                <img src="/assets/boneka2.jpg" alt="" class="rounded-lg w-[200px]">
                </div>
                </div>
                </div>
                <div class="max[300px]">
                <img src="/assets/kucingggggg.jpg" alt="" class="rounded-lg w-[400]">
                </div>
            </div>
        </div>
    </div>
